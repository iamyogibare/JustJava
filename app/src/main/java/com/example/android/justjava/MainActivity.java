...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        String priceMessage = createOrderSummary(price, hasCinnamon, hasChocolate);
    ...
    private String createOrderSummary(int price, boolean hasCinnamon, boolean hasChocolate) {
